...
export const MobileFooter: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-sm mx-auto relative z-10 space-y-3.5">
        {/* FILA SUPERIOR: Logo Oficial a la izquierda + Redes Sociales a la derecha */}
        <div className="flex items-center justify-between gap-3">
          {/* Logo Oficial con Aura */}
          <motion.a
            href="#inicio"
            onClick={(e) => {
              e.preventDefault();
            ...
            className="flex items-center gap-2.5 group cursor-pointer select-none shrink-0 relative"
          ...
          >
            <div className="relative flex items-center justify-center">
              ...
              />
              <div className="absolute -inset-0.5 rounded-full bg-[#D4AF37]/35 blur-xs pointer-events-none" />
              ...
              <img
                ...
                width="36"
                height="36"
                className="relative z-10 w-8 h-8 object-contain rounded-full drop-shadow-[0_0_10px_rgba(212,175,55,0.8)] filter contrast-[1.05] brightness-[1.05]"
              />
            </div>
            <div className="flex flex-col text-left relative z-10 leading-tight">
              <span className="font-serif text-sm font-black tracking-[0.18em] text-white leading-tight drop-shadow-[0_0_6px_rgba(212,175,55,0.4)]">
                MIRANDA
              </span>
              <span className="text-[9.5px] tracking-[0.24em] font-sans font-black uppercase text-[#D4AF37] drop-shadow-[0_1px_2px_rgba(0,0,0,0.95)] drop-shadow-[0_0_8px_rgba(212,175,55,0.8)] select-none">
                DENTAL STUDIO
              </span>
            </div>
          </motion.a>
        ...
        {/* FILA INTERMEDIA: Descripción clínica */}
        <p className="text-[11px] text-stone-400 font-medium leading-relaxed text-center">
