...
export const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    <div className="hidden lg:flex fixed bottom-8 right-8 z-40 flex-col items-end gap-2 select-none">
      {/* Tooltip */}
      {showTooltip && (
        <div className="bg-white/95 backdrop-blur-md px-4 py-2 rounded-2xl shadow-xl border border-[#D4AF37]/40 text-xs font-bold text-[#0D0D0D] flex items-center gap-2 animate-in fade-in slide-in-from-bottom-2 duration-300">
